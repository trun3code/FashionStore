...
const SearchBar = ({ getData, setData }) => {
    const [str, setStr] = useState("");
    const handleSearch = async () => {
        setData(await getData(str));
    }
    return (
        <div className="w-[33%] h-[5rem] pt-[1.25rem] m-auto">
            <div className="relative ">
                <input className="w-full bg-transparent placeholder:text-slate-400 text-slate-700 
                text-sm border border-slate-200 rounded-md pl-3 pr-28 py-2 transition duration-300 ease 
                ...
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 mr-2">
                        ...
                        8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clipRule="evenodd" />
                    </svg>
                </button>
            </div>
        </div>
